...
function App() {
  ...
  const handleSendMessage = (e) => {
    ...
    if (input.trim() !== "") {
      let newMsg = { text: input, sender: name };
      socket.emit("sendmessageinroom",room , newMsg);
    ...
    <div className="flex   ">
      {!submitted ? (
        <div className="flex items-center justify-center min-h-screen ">
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 mt-5"
              required
            />
            <button
              type="submit"
        ...
        <div className="flex flex-col w-full  h-[85vh] bg-white rounded-xl shadow-md p-4">
          ...
          <h2 className="text-xl font-semibold mb-2 text-center text-black">Welcome, {room}!</h2>
